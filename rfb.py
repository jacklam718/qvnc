...
class RFBClient(Protocol):
    ...
    def _handleInitial(self):
        ...
        if '\n' in buffer:
            ...
            #self.transport.write("RFB 004.001\n")
            log.msg("connected\n")
            self._packet[:] = [buffer]
